...
2) En la función que dibuja el <canvas> de exportación —la misma que usan
   todas las diapositivas—, el MISMO trazado. Quita los moveTo, lineTo,
   strokeStyle, lineWidth y lineCap del símbolo, y pon:
